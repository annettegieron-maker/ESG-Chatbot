...
class ESGScoringBot:
    def __init__(self):
        ...
        self.fields = [
            {"name": "kd_esgg", "label": "KD bzw. KD ESGG", "question": "3-6 stellige Nummer"},
            {"name": "kurzbezeichnung", "label": "Kurzbezeichnung", "question": "Gemäß Kreda"},
            {"name": "leit_kd", "label": "Leit-KD", "question": "Digi-Akte Nummer"},
            {"name": "fertigstellungstermin", "label": "Fertigstellung", "question": "TT.MM.JJJJ"},
            {"name": "kurze_begruendung", "label": "Begründung", "question": "Frist-Anlass"},
            {"name": "mitarbeiter_anzahl", "label": "Mitarbeiter", "question": "Positive Zahl"},
            {"name": "umsatz_teur", "label": "Umsatz TEUR", "question": "Positive Zahl"},
            {"name": "bilanzsumme_teur", "label": "Bilanzsumme", "question": "Positive Zahl"},
            {"name": "sonstiges", "label": "Sonstiges", "question": "Optional"},
            {"name": "korruptionsrisiko", "label": "Korruptionsrisiko", "question": "1-6 wählen"},
            {"name": "begruendung_korruptionsrisiko", "label": "Begründung Korruption", "question": "Erklären"},
            {"name": "unternehmensfuehrung", "label": "Unternehmensführung", "question": "1-6 wählen"},
            {"name": "begruendung_unternehmensfuehrung", "label": "Begründung Führung", "question": "Erklären"},
            {"name": "esgg_verknuepfung", "label": "ESGG-Verknüpfung", "question": "1-3 wählen"},
            {"name": "esgg_betroffene_kds", "label": "Betroffene KDs", "question": "KD-Nummern"}
        ]
...
def main():
    ...
    if bot.current_field < 15:
        ...
        if field['name'] == "fertigstellungstermin":
            ...
            user_input = st.text_input("Ihre Eingabe:", key=f"input_{bot.current_field}")
